        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="#"
                className="w-10 h-10 bg-muted rounded-full flex items-center justify-center hover:bg-primary hover:text-white transition-all duration-300"
            ...
            <div className="mt-4">
              ...
              <p className="text-sm font-semibold" data-testid="footer-email">
                contato@marquinhaperfeita.com
              </p>
              <p className="text-sm font-semibold" data-testid="footer-phone">
                (11) 99999-9999
              </p>
            </div>
          </div>
